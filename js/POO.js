...
console.log("El nombre del tuto es:",tutor.nombre);
...
console.log("Profesor con propiedad sexo eliminada -->",profesor);
...
//Comparo los espacios de memoria de los objetos no los objetos en si
